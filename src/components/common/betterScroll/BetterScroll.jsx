...
class BetterScroll extends PureComponent {
  ...
  componentDidMount() {
    EventBus.addListener('noTouchMove', this.noTouchMove)
    EventBus.addListener('onTouchMove', this.onTouchMove)
  ...
  componentWillUnmount() {
    EventBus.removeListener('noTouchMove', this.noTouchMove)
    EventBus.removeListener('onTouchMove', this.onTouchMove)
  }
}
