    ...
    return (
      <HomeGoodsListItemStyle>
        <li className='goods-list-item' onClick={(e) => { this.goDetail(e, goods.id) }}>
          ...
          {
            (goods.isshow === '3' || goods.gnum === '0') &&
            <img src='https://res.lexiangpingou.cn/images/vip/maiwan.png' className='__--__' alt='' />
          }

          {
            (goods.selltype === '1' || goods.selltype === '4' || goods.selltype === '7' || goods.selltype === '6' || goods.is_experience === '2') &&
            <button className='goods-button' >{groupText}</button>
          }
        </li>
      </HomeGoodsListItemStyle>
    )
