...
class PaySuccess extends Component {
          ...
          <Fragment><div className="center1">
            ...
            <div className="center1frame">
              ...
              <div className="center1textframe">
                <div className="center1text1">核销成功</div>
            ...
            <div className="center2">
              ...
              <button className="center2btn2" onClick={this.jumpOrder}>确定</button>
              <button className="center2btn1" onClick={this.jumpList}>继续核销</button>
            </div>
          </Fragment>}
  ...
  jumpOrder = () => {
    ...
    this.props.history.replace(`/order/all/1`)
  }
